;(function () {
    ...
    function removeFlash() {
        var nodelist = document.querySelectorAll('object');
    ...
    function ViewModel(params) {
        var model = {
            modal: {
                tag: false,
                tag_name: 'icon_tag' + params.icon.id,
                tab_name: 'icon_tab' + params.icon.id,
                tab: false
            },
            items: [],
            info: {
        ...
        this.params = params.icon;
        this.parent = params.parent;
        this.data_type = ['链接到标签', '链接到资源', 'URL地址'];
        this.storeUrl = '';
        this.icon_modal = '#icon-modal-' + this.params.id;
        this.drag_name = '#icon-drag-' + this.params.id;
        this.init();
    ...
    ViewModel.prototype.getTitle = function ($data) {
        switch ($data.data_type) {
            case 1:
                return $data.tag_name ? $data.tag_name : $data.channel_name;
            case 2:
        ...
        $(this.drag_name).dragsort({
            ...
            dragEnd: function () {
                ...
                _self.store.move(param.section_data_id, param.next_section_data_id).done(function (data) {
                    ...
                    //_self.parent.getChannelSection.call(_self.parent);
                });
            }
    ...
    ko.components.register('x-channel-icon', {
        synchronous: true,
        viewModel: ViewModel,
