;(function ($, window) {
    ...
    var NDRCODEMAP = {
        ...
        'nd_mathaxi': '$RE0447',
        'nd_optionalchoice': '$RE0237',
        'nd_enoral_word': '$RE0459',
        'nd_enoral_sentence': '$RE0460',
        'nd_enoral_paragraph': '$RE0461',
        'nd_enoral_dialogue': '$RE0462',
        'nd_enoral_composition': '$RE0463'
    };
    var APICODEMAP = {
        '10': 'choice',
        '15': 'multiplechoice',
        ...
        '447': 'nd_mathaxis',
        '237': 'nd_optionalchoice',
        '459': 'nd_enoral_word',
        '460': 'nd_enoral_sentence',
        '461': 'nd_enoral_paragraph',
        '462': 'nd_enoral_dialogue',
        '463': 'nd_enoral_composition'
    };
    ...
    var questionTypeData = {
        ...
        'nd_optionalchoice': {key: 'nd_optionalchoice', desc: '选做题', count: 0}
    ...
    var courseWareObjectsTypeData = {
        ...
        'nd_enoral_word': {key: 'nd_enoral_word', desc: '英语口语单词', count: 0},
        'nd_enoral_sentence': {key: 'nd_enoral_sentence', desc: '英语口语句子', count: 0},
        'nd_enoral_paragraph': {key: 'nd_enoral_paragraph', desc: '英语口语段落', count: 0},
        'nd_enoral_dialogue': {key: 'nd_enoral_dialogue', desc: '英语口语对话', count: 0},
        'nd_enoral_composition': {key: 'nd_enoral_composition', desc: '英语口语作文', count: 0}
    };
        ...
        for (var key in params) {
            if (params.hasOwnProperty(key)) {
                ...
                if ($.isArray(value)) {
                    ...
                    for (var i = 0; i < len; i++) {
                        trimVal = encodeURIComponent($.trim(value[i]));
                        if (trimVal !== "") str += key + '=' + trimVal + "&";
                    }
                } else {
                    trimVal =encodeURIComponent($.trim(value));
                    if (trimVal !== "") str += key + '=' + trimVal + "&";
                }
            }
        }
