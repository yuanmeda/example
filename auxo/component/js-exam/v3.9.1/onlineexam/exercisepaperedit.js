...
(function (w, $) {
    function Model(params) {
        ...
        this.store = {
            ...
            get: function (url, projectCode, exerciseId) {
                var url = url ? url : '/' + projectCode + '/v1/exercises/' + exerciseId + '/strategy';
                return $.ajax({
                    url: url,
                    type: 'get',
                    dataType: "json",
            ...
            getQuestionBanks: function (url, projectCode) {
                var url = url ? url +'?page=0&size=1000&type=2' : '/' + projectCode + '/v1/questionbanks?page=0&size=1000&type=2';
                return $.ajax({
                    url: url,
                    type: 'get',
                    dataType: "json",
    ...
    Model.prototype = {
        ...
        _init: function () {
            ...
            this.model.exercise.paper_list.subscribe(function (val) {
                this.refreshBtnActive(ko.mapping.toJS(val));
            }, this);
            this.list(true);
        },
        ...
        savePapers: function () {
            ...
            var originalPaperList = ko.mapping.toJS(this.model.exercise.paper_list);
            ...
            ko.mapping.fromJS(originalPaperList, {}, this.model.exercise.paper_list);
        ...
        list: function (flag) {
            var self = this;
            this.store.get(this.params.getStragegyUrl, this.params.projectCode, this.params.exerciseId)
                .done(function (data) {
                    if (flag) {
                        self.resetQuestionType(data.paper_list);
                        self.model.originalPapers = data.paper_list;
                        data.exercise_strategy = data.exam_strategy + '';
                        ...
                        self.resetQuestionType(data.paper_list);
                        var originalPaperList = ko.mapping.toJS(self.model.exercise.paper_list);
                        ...
                        ko.mapping.fromJS(originalPaperList, {}, self.model.exercise.paper_list);
                    }
        ...
        updateDisabled: function (disabled) {
            var self = this;
            $.each(self.model.exercise.paper_list(), function (index, element) {
        ...
        _validator: function () {
            ...
            $.validator.addMethod("papersRequired", function (val, element) {
                var count = 0;
                $.each(this.model.exercise.paper_list(), function (index, element) {
                    if (!element.disabled()) {
                        count++;
                    }
                });
            ...
            $.validator.addMethod("papersWithEqualScore", $.proxy(function (val, element) {
                if ($('input:radio[name="exerciseStrategy"]:checked').val() == '2') {
                    return true;
                }
                var papers = ko.mapping.toJS(this.model.exercise.paper_list);
                var tatalScore = -1;
            ...
            $.validator.addMethod("questionsRequired", function (val, element) {
                ...
                return this.model.exercise.question_setting_list().length > 0;
            }, "题目设置不能为空");
            ...
            $.validator.addMethod("countLeTotal", function (value, element) {
                ...
                var total = 0;
                $.each(self.model.exercise.question_setting_list(), function (index, element) {
        ...
        resetQuestionType: function (list) {
            if (!list) {
                list = ko.mapping.toJS(this.model.exercise.paper_list);
            }
            var questionCount = {};
        ...
        getLastQuestionSetting: function () {
            var list = ko.mapping.toJS(this.model.exercise.question_setting_list);
            if (list.length) {
        ...
        addQuestionSetting: function () {
            ...
            this.model.exercise.question_setting_list.push(item);
        ...
        online: function () {
            var _self = this;
            this.store.online(this.params.projectCode, this.params.exerciseId)
                .done(function () {
