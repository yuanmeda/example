    ...
    Model.prototype = {
        ...
        getNDRQuestionCount: function (assessment) {
            ...
            if (assessment && assessment.test_parts && assessment.test_parts.length > 0) {
                $.each(assessment.test_parts, function (index, part) {
                    if (part.assessment_sections && part.assessment_sections.length > 0) {
                        questionCount = questionCount + part.assessment_sections.length;
                    }
                });
            }
