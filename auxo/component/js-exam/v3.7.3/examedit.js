...
(function (w, $) {
    ...
    Model.prototype = {
         ...
         */
        _init: function () {
            // $('#beginTime').datetimepicker({language: 'zh-CN', autoclose: true});
            // $('#endTime').datetimepicker({language: 'zh-CN', autoclose: true});
            // $('#acBeginTime').datetimepicker({language: 'zh-CN', autoclose: true});
            // $('#acEndTime').datetimepicker({language: 'zh-CN', autoclose: true});
