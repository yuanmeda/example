...
(function ($) {
    $.widget('learning.navigator', {
        ...
        _init: function () {
            ...
            $(document).off('click', '.ln-btn-cart', $.proxy(this._onSidCollapseClick, this)).on('click', '.ln-btn-cart', $.proxy(this._onSidCollapseClick, this));
...
define('learning.prepare', [
    ...
    (function ($) {
        ...
        var oldtmpl = '<div class="test-enter" style="z-index:99;">    <!--ko if:!$root.mobileOrNot()-->    <div class="test-enter-con">        <h2 data-bind="html:title"></h2>        <div class="testpaper-info">            <ul class="clearfix" data-bind="css: {testpaperInfoUlCenter: $root.subType() == 1}">                <li data-bind="css: {testpaperInfoLi: $root.subType() == 1}"><i class="ico-question"></i><b data-bind="html:quCount"></b><span data-bind="text: $root.i18n.question"></span></li>                <!--ko if:$root.subType() != 1-->                <li><i class="ico-score"></i><b data-bind="html:score"></b><span data-bind="text: $root.i18n.totalScore"></span></li>                <!--/ko-->                <!--ko if:$root.subType() != 1 && $root.subType() != 2-->                <li><i class="ico-cond"></i><b data-bind="html:$root.passScoreTitle(passScore())"></b><span data-bind="text: $root.i18n.pass"></span></li>                <!--/ko-->                <li><i class="ico-time"></i><b data-bind="html:completionSeconds()?completionSeconds():$root.i18n.noEndTime"></b><span data-bind="text: $root.i18n.minute"></span></li>            </ul>        </div>        <!--ko if:$root.rankingAble() == true-->        <!--ko if:$root.rank() == 1-->            <div data-bind="visible: $root.showRankingUrl()" class="testpaper-info text-center" style="border: none; margin-top: 50px;">                <!--ko if:$root.subType() != 1-->                    <a class="l-ranking" data-bind="text: $root.i18n.ranking, attr: { href: $root.rankingUrl }"></a>                <!-- /ko -->            </div>        <!-- /ko -->        <!-- /ko-->        <div data-bind="visible: $root.showHistory() || $root.showHightSocre()" class="testpaper-info text-center" style="border: none; margin-top: 50px;">            <div class="test-history">                <div class="history" data-bind="visible: $root.showHightSocre()">                    <!--ko if:$root.subType() != 1-->                    <span class="info" data-bind="text: $root.i18n.bestScore"></span>                    <!--/ko-->                    <!--ko if:$root.subType() == 1-->                    <span class="info" data-bind="text: $root.i18n.lastAnswer"></span>                    <!--/ko-->                    <!--ko if:$root.subType() != 1-->                        <span class="score" data-bind="css: { success: $root.isPassed(), fail: !$root.isPassed() }, text: $root.getBestScore()"></span>                        <span class="info" data-bind="css: { success: $root.isPassed(), fail: !$root.isPassed() }, text: $root.i18n.score"></span>                    <!-- /ko -->                    <!--ko if:$root.subType() == 1-->                        <span class="info fail" data-bind="text: $root.resultCode"></span>                    <!-- /ko -->                    <a data-bind="visible: $root.showHistory(), attr: { href: $root.historyScoreUrl }, text: $root.getHistoryText()" class="l-history" href="javascript:void(0)"></a>                </div>            </div>        </div>        <div data-bind="visible: ($root.subType() == 2 || $root.subType() == 3) && (window.projectCode != \'onetest\' && window.projectCode != \'autonomiclearning\' && window.projectCode != \'chaungguan\')" style="border: none; margin-top: 50px;">            <p data-bind="visible: $root.subType() == 2, html: $root.i18n.notSupport.subType2" style="text-align:center; font-size:14px; color:red;"></p>            <p data-bind="visible: $root.subType() == 3, html: $root.i18n.notSupport.subType3" style="text-align:center; font-size:14px; color:red;"></p>        </div>        <div class="test-enter-btns">            <div class="text-center">                <div class="test-enter-cd countdown" data-bind="visible: $root.showCountDown() && !$root.largetThenSeven()">                    <em class="j-ln-exam-tick"></em>                </div>                <div class="test-enter-cd" data-bind="visible: $root.isTimerReady() && $root.showExamEndTime()">                    <span data-bind="text: $root.i18n.examStartTime"></span><em data-bind="text: $root.getBeginTime()"></em>                </div>            </div>            <br/>            <div class="enter-btns">                <div class="inl" style="margin-right: 15px;">                    <a href="javascript:void(0);" class="co-ln-btn" data-bind="click: $root.onCollection, text: $root.collectionDisabled() ? $root.i18n.cancelCollection : $root.i18n.collection, css: { \'disabled\': $root.collectionDisabled }"></a>                </div>                <div  class="inl">                    <!--ko if: ($root.subType() == 2 || $root.subType() == 3) && (window.projectCode != \'onetest\' &&window.projectCode != \'autonomiclearning\' && window.projectCode != \'chaungguan\')-->                        <a href="javascript:void(0);" class="ln-btn disabled" data-bind="text: $root.i18n.examStatus.disabled"></a>                    <!--/ko-->                    <!--ko if: ($root.subType() != 3 && $root.subType() != 2) || window.projectCode == \'onetest\' || window.projectCode == \'autonomiclearning\' || window.projectCode == \'chaungguan\'-->                            <!-- ko if:$root.isTimerReady() -->                                <!-- ko if:$root.isExamEnd() -->                                    <!-- ko if:$root.userExamStatus()==8 -->                                        <!-- ko if:$root.canContinue() -->                                            <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.onPrepareButtonClick()}, text: $root.i18n.examStatus.continue"></a>                                        <!-- /ko -->                                        <!-- ko if:!$root.canContinue() -->                                            <!-- ko if:$root.remainingTryTimes()>0 -->                                                <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.onPrepareButtonClick()}"><span data-bind="text: $root.i18n.examStatus.retry1"></span><span data-bind="text: $root.remainingTryTimes()"></span><span data-bind="text: $root.i18n.examStatus.retry2"></span></a>                                            <!-- /ko -->                                            <!--ko if:$root.remainingTryTimes()<=0 -->                                                <a href="javascript:void(0);" class="ln-btn disabled" data-bind="text: $root.i18n.examStatus.noRetryTimes"></a>                                            <!-- /ko -->                                        <!-- /ko -->                                    <!-- /ko -->                                    <!-- ko if:$root.userExamStatus()!=8 -->                                        <!-- ko if:$root.userExamStatus()==16 -->                                            <a href="javascript:void(0);" class="ln-btn disabled" data-bind="text: $root.i18n.examStatus.waitingPerusal"></a>                                        <!-- /ko -->                                        <!-- ko if:$root.userExamStatus()!=16 -->                                            <a href="javascript:void(0);" class="ln-btn disabled" data-bind="text: $root.i18n.examStatus.ended"></a>                                        <!-- /ko -->                                    <!-- /ko -->                                <!-- /ko -->                                <!-- ko if:!$root.isExamEnd() -->                                    <!-- ko if:$root.userExamStatus()<=0 -->                                        <a href="javascript:void(0);" class="ln-btn disabled" data-bind="text: $root.i18n.examStatus.disabled"></a>                                    <!-- /ko -->                                    <!-- ko if:$root.userExamStatus()>=8 -->                                        <!-- ko if:$root.userExamStatus()==8 -->                                            <!-- ko if:$root.canContinue() -->                                                <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.onPrepareButtonClick()}, text: $root.i18n.examStatus.goon"></a>                                            <!-- /ko -->                                            <!-- ko if:!$root.canContinue() -->                                                <!-- ko if:$root.remainingTryTimes()>0 -->                                                    <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.onPrepareButtonClick()}"><span data-bind="text: $root.i18n.examStatus.retry1"></span><span data-bind="text: $root.remainingTryTimes()"></span><span data-bind="text: $root.i18n.examStatus.retry2"></span></a>                                                <!-- /ko -->                                                <!-- ko if:$root.remainingTryTimes()<=0 -->                                                    <a href="javascript:void(0);" class="ln-btn disabled" data-bind="text: $root.i18n.examStatus.noRetryTimes"></a>                                                <!-- /ko -->                                            <!-- /ko -->                                        <!-- /ko -->                                        <!-- ko if:$root.userExamStatus()!=8 -->                                            <!-- ko if:$root.userExamStatus()==16 -->                                                <!-- ko if:$root.markedNotStarted() -->                                                    <!--ko if: $root.enrollType() == 5-->                                                        <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.enrollButtonClick()},text: $root.i18n.examStatus.enrollNow"></a>                                                    <!--/ko-->                                                    <!--ko if: $root.enrollType() != 5-->                                                        <a href="javascript:void(0);" class="ln-btn disabled" data-bind="text: $root.i18n.examStatus.wait"></a>                                                    <!--/ko-->                                                <!-- /ko -->                                                <!-- ko if:!$root.markedNotStarted() -->                                                    <a href="javascript:void(0);" class="ln-btn disabled" data-bind="text: $root.i18n.examStatus.waitingPerusal"></a>                                                <!-- /ko -->                                            <!-- /ko -->                                            <!-- ko if:$root.userExamStatus()!=16 -->                                                <!-- ko if:$root.markedNotStarted() -->                                                    <!--ko if: $root.enrollType() == 5-->                                                        <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.enrollButtonClick()},text: $root.i18n.examStatus.enrollNow"></a>                                                    <!--/ko-->                                                    <!--ko if: $root.enrollType() != 5-->                                                        <a href="javascript:void(0);" class="ln-btn disabled" data-bind="text: $root.i18n.examStatus.wait"></a>                                                    <!--/ko-->                                                <!-- /ko -->                                                <!-- ko if:$root.remainingTryTimes()>0 && !$root.markedNotStarted() -->                                                    <!--ko if: $root.remainingTryTimes() <= 1000 -->                                                        <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.onPrepareButtonClick()}">                                                            <span data-bind="text: $root.i18n.examStatus.retry1"></span>                                                            <span data-bind="text: $root.remainingTryTimes()"></span>                                                            <span data-bind="text: $root.i18n.examStatus.retry2"></span>                                                        </a>                                                    <!--/ko-->                                                    <!--ko if: $root.remainingTryTimes() > 1000-->                                                        <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.onPrepareButtonClick()}">                                                            <span data-bind="text: $root.i18n.examStatus.retryNoLimit()"></span>                                                        </a>                                                    <!--/ko-->                                                <!-- /ko -->                                                <!-- ko if:$root.remainingTryTimes()<=0 && !$root.markedNotStarted() -->                                                    <a href="javascript:void(0);" class="ln-btn disabled" data-bind="text: $root.i18n.examStatus.noRetryTimes"></a>                                                <!-- /ko -->                                            <!-- /ko -->                                        <!-- /ko -->                                    <!-- /ko -->                                    <!-- ko if:$root.userExamStatus()<8 -->                                        <!-- ko if:$root.userExamStatus()>0 -->                                            <!-- ko if:$root.remainingTryTimes()<=0 -->                                                <a href="javascript:void(0);" class="ln-btn disabled" data-bind="text: $root.i18n.examStatus.disabled"></a>                                            <!-- /ko -->                                            <!-- ko if:$root.remainingTryTimes()>=1 -->                                                <!-- ko if:$root.userExamStatus()==1 -->                                                    <!-- ko if:!$root.isExamStarted() -->                                                        <!--ko if: $root.enrollType() == 1 || $root.enrollType() == 2-->                                                            <!--ko if: $root.userEnrollType() == null-->                                                                <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.enrollButtonClick()},text: $root.i18n.examStatus.enrollNow"></a>                                                            <!--/ko-->                                                            <!--ko if: $root.userEnrollType() != null-->                                                                <!--ko if: $root.userEnrollType() == 0-->                                                                    <a href="javascript:void(0);" class="ln-btn disabled" data-bind="text: $root.i18n.examStatus.pendingAudit"></a>                                                                <!--/ko-->                                                                <!--ko if:$root.userEnrollType() == 2-->                                                                    <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.enrollButtonClick()},text: $root.i18n.examStatus.reEnrollNow"></a>                                                                    <div class="wt-reject">                                                                        <b data-bind="text: $root.i18n.reason"></b>                                                                        <span class="wt-txt-newline" data-bind="text: $root.opinion()"></span>                                                                    </div>                                                                <!--/ko-->                                                                <!--ko if: $root.userEnrollType() == 12-->                                                                    <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.enrollButtonClick()},text: $root.i18n.examStatus.paying"></a>                                                                <!--/ko-->                                                                <!--ko if: $root.userEnrollType() == 5 || $root.userEnrollType() == 13-->                                                                    <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.enrollButtonClick()},text: $root.i18n.examStatus.enrollNow"></a>                                                                <!--/ko-->                                                                <!--ko if: $root.userEnrollType() == 1 || $root.userEnrollType() == 4 || $root.userEnrollType() == 8-->                                                                    <a href="javascript:void(0);" class="ln-btn disabled" data-bind="text: $root.i18n.examStatus.wait"></a>                                                                <!--/ko-->                                                            <!--/ko-->                                                        <!--/ko-->                                                        <!--ko if: $root.enrollType() == 0 || $root.enrollType() == 4-->                                                            <a href="javascript:void(0);" class="ln-btn disabled" data-bind="text: $root.i18n.examStatus.wait"></a>                                                        <!--/ko-->                                                    <!--/ko-->                                                <!--/ko-->                                                <!--ko if: $root.userExamStatus() == 4-->                                                    <!--ko if:$root.enrollType() == 0-->                                                        <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.onPrepareButtonClick()}, text: $root.i18n.examStatus.start"></a>                                                    <!--/ko-->                                                    <!--ko if:$root.enrollType() != 0 && $root.userEnrollType() == null-->                                                        <!--ko if:$root.enrollType() == 4-->                                                            <a href="javascript:void(0);" class="ln-btn disabled" data-bind="text: $root.i18n.examStatus.notEnroll"></a>                                                        <!--/ko-->                                                        <!--ko if:$root.enrollType() == 2 || $root.enrollType() == 1-->                                                            <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.enrollButtonClick()},text: $root.i18n.examStatus.enrollNow"></a>                                                        <!--/ko-->                                                        <!--ko if:$root.enrollType() == 5-->                                                            <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.enrollButtonClick()},text: $root.i18n.examStatus.enrollNow"></a>                                                        <!--/ko-->                                                    <!--/ko-->                                                    <!--ko if:$root.enrollType() != 0 && $root.userEnrollType() != null-->                                                        <!--ko if:$root.enrollType() == 4-->                                                            <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.onPrepareButtonClick()}, text: $root.i18n.examStatus.start"></a>                                                        <!--/ko-->                                                        <!--ko if:$root.enrollType() == 5 || $root.enrollType() == 1-->                                                            <!--ko if:$root.userEnrollType() == 0-->                                                                <a href="javascript:void(0);" class="ln-btn disabled" data-bind="text: $root.i18n.examStatus.pendingAudit"></a>                                                            <!--/ko-->                                                            <!--ko if:$root.userEnrollType() == 2-->                                                                <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.enrollButtonClick()},text: $root.i18n.examStatus.reEnrollNow"></a>                                                                <div class="wt-reject">                                                                    <b data-bind="text: $root.i18n.reason"></b>                                                                    <span class="wt-txt-newline" data-bind="text: $root.opinion()"></span>                                                                </div>                                                            <!--/ko-->                                                            <!--ko if: $root.userEnrollType() == 12-->                                                                <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.enrollButtonClick()},text: $root.i18n.examStatus.paying"></a>                                                            <!--/ko-->                                                            <!--ko if:$root.userEnrollType() == 5 || $root.userEnrollType() == 13-->                                                                <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.enrollButtonClick()},text: $root.i18n.examStatus.enrollNow"></a>                                                            <!--/ko-->                                                            <!--ko if:$root.userEnrollType() == 1 ||$root.userEnrollType() == 4 || $root.userEnrollType() == 8-->                                                                <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.onPrepareButtonClick()}, text: $root.i18n.examStatus.start"></a>                                                            <!--/ko-->                                                        <!--/ko-->                                                        <!--ko if:$root.enrollType() == 2-->                                                            <!--ko if:$root.userEnrollType() == 0-->                                                                <a href="javascript:void(0);" class="ln-btn disabled" data-bind="text: $root.i18n.examStatus.pendingAudit"></a>                                                            <!--/ko-->                                                            <!--ko if:$root.userEnrollType() == 2-->                                                                <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.enrollButtonClick()},text: $root.i18n.examStatus.reEnrollNow"></a>                                                                <div class="wt-reject">                                                                    <b data-bind="text: $root.i18n.reason"></b>                                                                    <span class="wt-txt-newline" data-bind="text: $root.opinion()"></span>                                                                </div>                                                            <!--/ko-->                                                            <!--ko if: $root.userEnrollType() == 12-->                                                                <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.enrollButtonClick()},text: $root.i18n.examStatus.paying"></a>                                                            <!--/ko-->                                                            <!--ko if:$root.userEnrollType() == 5 || $root.userEnrollType() == 13-->                                                                <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.enrollButtonClick()},text: $root.i18n.examStatus.enrollNow"></a>                                                            <!--/ko-->                                                            <!--ko if:$root.userEnrollType() == 1 ||$root.userEnrollType() == 4 || $root.userEnrollType() == 8-->                                                                <a href="javascript:void(0);" class="ln-btn" data-bind="click: function() {$root.onPrepareButtonClick()}, text: $root.i18n.examStatus.start"></a>                                                            <!--/ko-->                                                        <!--/ko-->                                                    <!--/ko-->                                                <!--/ko-->                                            <!--/ko-->                                        <!--/ko-->                                    <!--/ko-->                                <!--/ko-->                            <!--/ko-->                    <!--/ko-->                </div>            </div>        </div>        <div class="test-enter-alert">            <div>                <h4 data-bind="text: $root.i18n.examTimeTitle"></h4>                <br/>                <span data-bind="text: $root.getExamBeginTime()"></span>&nbsp;&nbsp;&nbsp;<span data-bind="text: $root.i18n.toText"></span>&nbsp;&nbsp;&nbsp;<span data-bind="text: $root.getExamEndTime()"></span>            </div>            <br/>            <div data-bind="visible: $root.examDetail().length>0">                <h4 data-bind="text: $root.i18n.examSummary"></h4>                <br/>                <div data-bind="html: $root.examDetail" class="exam-description"></div>            </div>            <br/>            <div>                <div class="imp-txt">                    <i></i>                    <b data-bind="text: $root.i18n.caution"></b>:                </div>                <br/>                <br/>                <ol>                    <li data-bind="text: $root.i18n.cautionItem1"></li>                    <li data-bind="text: $root.i18n.cautionItem2"></li>                </ol>            </div>        </div>    </div>    <!-- /ko -->    <!--ko if:$root.mobileOrNot()-->    <div class="test-enter-con">        <div class="testpaper-info text-center" style="border: none;">            <span class="fail-message" data-bind="text: $root.i18n.toMobile"></span>        </div>    </div>    <!-- /ko --></div>        ';
...
define('learning.ranking', [
    ...
    (function ($) {
        ...
        var store = {
            list: function (projectCode, examId, pageSize, pageIndex, language) {
                return $.ajax({
                    url: '/' + projectCode + '/v1/m/exams/' + examId + '/users/ranking?page=' + pageIndex + '&size=' + pageSize,
                    type: 'get',
                    dataType: 'json',
                    requestCase: 'snake',
                    responseCase: 'camel',
            ...
            my: function (projectCode, examId, userId, language) {
                return $.ajax({
                    url: '/' + projectCode + '/v1/m/exams/' + examId + '/users/ranking/' + userId,
                    type: 'get',
                    dataType: 'json',
                    requestCase: 'snake',
                    responseCase: 'camel',
        ...
        $.widget('learning.ranking', {
            ...
            list: function () {
                var examId = this._vm.examId(), projectCode = this._vm.projectCode(), pageSize = this._vm.rankings.pageSize(), pageIndex = this._vm.rankings.pageIndex(), language = this._vm.language();
                this._vm.status.loading(true);
                return store.list(projectCode, examId, pageSize, pageIndex, language);
            },
            loadMy: function () {
                var examId = this._vm.examId(), projectCode = this._vm.projectCode(), userId = this._vm.userId(), language = this._vm.language();
                return store.my(projectCode, examId, userId, language);
            }
        });
    }(jQuery));
});
    ...
    (function (Learning) {
        var ExamSingleAnswer = function (_super) {
            ...
            function ExamSingleAnswer() {
                ...
                this._tmpl = '                <div>                    <div class="prepare"></div>                    <div class="test-box">                        <div class="test-main">                            <div class="test-toolbar-top">                                <div class="wt-tool-left" style="display: none;">                                    <span class="wt-timer">                                        <ins></ins><span class="wt-timer-clock wt-active"></span>                                    </span>                                </div>                                <div class="wt-tool-right">                                    <a href="javascript:void(0);" class="wt-result-btn ln-btn-finish wt-active" style="display: none;">                                        <span id="submit">提交考试</span>                                    </a>                                </div>                            </div>                            <div class="test-wrapper">                                <div class="w-test-con">                                    <div class="question w-item-list"></div>                                </div>                                <div class="w-test-sheet">                                    <div class="wt-sheet">                                        <div class="wt-sheet-hd clearfix">                                            <ul>                                                <li class="active"><a href="javascript:void(0);" id="navigator">答题卡</a></li>                                            </ul>                                        </div>                                        <div class="navigator"></div>                                    </div>                                </div>                                <div class="w-test-alert1" style="display: none;"></div>                            </div>                            <div class="test-toolbar">                                <a href="javascript:;" class="wt-question-prev ln-btn-prev wt-prev-disabled">                                    <span id="prev"><i></i>上一题</span>                                </a>                                <a href="javascript:;" class="wt-question-cart ln-btn-cart">                                    <span id="cart"><i></i>答题卡</span>                                </a>                                <a href="javascript:;" class="wt-question-next ln-btn-next">                                    <span id="next"><i></i>下一题</span>                                </a>                            </div>                        </div>                    </div>                </div>        ';
            }
            ...
            ExamSingleAnswer.prototype.previewDone = function (element) {
                element.style.visibility = 'hidden';
                element.style.visibility = '';
            };
                ...
                store.commit().done(function () {
                    ...
                    store.end().done(function (data) {
                        if (data && data.userData && data.userData.subType == 1) {
                            var resultUrl;
                            var customerUrl = data && data.userData && data.userData.resultUrl;
                            var defaultUrl = store.data.Exam.ExamResultPageUrl + store.data.ExamId + '/' + store.data.SessionId;
                            if (customerUrl) {
                                resultUrl = customerUrl + data.userData.resultCode;
                            } else {
                                resultUrl = defaultUrl;
                                ...
                                $.fn.udialog.alert(title, {
                                    ...
                                    buttons: [{
                                            ...
                                            click: function () {
                                                var t = $(this);
                                                t['udialog']('hide');
                                                var url = store.data.Exam.ExamResultPageUrl + store.data.ExamId + '/' + store.data.SessionId;
                                                location.replace(url);
                                            },
                                            'class': 'default-btn'
                                        }],
            ...
            ExamSingleAnswer.prototype.goTo = function (num) {
                this.store.viewModel.navigator.num(num);
            };
...
define('learning.bussiness.base', [
    ...
    (function (Learning) {
        var BaseWrapper = function () {
            ...
            BaseWrapper.prototype.viewAnalysis = function () {
            };
            ...
            BaseWrapper.prototype.getSessionInfo = function () {
                return this.sendRequest({
                    url: this.config.host.mainHost + '/v1/m/exams/' + this.config.envConfig.examId + '/sessions/' + this.config.envConfig.sessionId,
                    type: 'GET',
                    dataType: 'json',
                    requestCase: 'snake',
                    responseCase: 'camel',
    ...
    (function (Learning) {
        ...
        (function (Bussiness) {
            var SingleModeExam = function (_super) {
                ...
                SingleModeExam.prototype.viewAnalysis = function () {
                    var _this = this;
                    $.learning.loading.show();
                    this.main = null;
                    $.when(this.getExamInfo(), this.getSessionInfo()).done(function (examData, mineData) {
                        var data = mineData[0], examInfo = examData[0];
                        examInfo.beginTime = $.format.toBrowserTimeZone(Date.ajustTimeString(examInfo.beginTime), 'yyyy/MM/dd HH:mm:ss');
                        examInfo.endTime = $.format.toBrowserTimeZone(Date.ajustTimeString(examInfo.endTime), 'yyyy/MM/dd HH:mm:ss');
                        data.beginTime = $.format.toBrowserTimeZone(Date.ajustTimeString(data.beginTime), 'yyyy/MM/dd HH:mm:ss');
                        ...
                        if (data.userData && data.userData.submitTime)
                            data.userData.submitTime = $.format.toBrowserTimeZone(Date.ajustTimeString(data.userData.submitTime), 'yyyy/MM/dd HH:mm:ss');
                        var answersData = [], analysisData = [], defs = [], qids = [];
                        if ((data.status == 16 || data.status == 32 || data.status == 80 || data.status == 96) && data.userData) {
                            Enumerable.from(data.userData.paper.parts).forEach(function (value, index) {
                                var qids = value.questionIdentities;
                                defs.push(_this.getUserQuestionAnswers(data.examId, data.sessionId, qids, function (answerData) {
                                    if (answerData && answerData.length > 0)
                                ...
                                defs.push(_this.getQuestionAnalysis(data.examId, data.sessionId, qids, function (data) {
                                    if (data && data.length > 0)
                                        analysisData = analysisData.concat(data);
                                }, _this.onError.bind(_this)));
                            });
                        }
                        $.when.apply({}, defs).done(function () {
                            _this._viewAnalysis(data, examData, answersData, analysisData);
                        });
                    }).fail($.proxy(this.onError, this));
                };
                SingleModeExam.prototype.entryExam = function (mine, exam, answersData, analysisData) {
                    $.learning.loading.hide();
                    var config = this._getConfig(mine, exam, answersData, analysisData);
                    $.learning.loading.show();
                ...
                SingleModeExam.prototype._viewAnalysis = function (mine, exam, answersData, analysisData) {
                    $.learning.loading.hide();
                    var config = this._getConfig(mine, exam, answersData, analysisData);
                    config.Exam.SingleModeConfig.Mode = 3;
                    config.ViewMode = 2;
                    $.learning.loading.show();
                    var main = this.main = new __answer.Learning.ExamSingleAnswer();
                    main.init(config);
                    if (main.store.data.UserExam.UserExamStatus == 16 || main.store.data.UserExam.UserExamStatus == 32 || main.store.data.UserExam.UserExamStatus == 80 || main.store.data.UserExam.UserExamStatus == 96) {
                ...
                SingleModeExam.prototype._getConfig = function (mine, exam, answersData, analysisData) {
                    var config = {
