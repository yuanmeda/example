; (function ($) {
    ...
    var store = {
        /*操作日志查询*/
        getOperateLog: function (user_id_sr, ip_address, module, op_object, custom_type, log_date_begin, log_date_end, page_size, current_page) {
            ...
            filter += custom_type ? " and custom_type eq '" + custom_type + "'": '';
