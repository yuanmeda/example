(function ($) {
    ...
    var store = {
        ...
        get: function () {
            var url = online_exam_gateway_url + '/v1/online_exam_edits/' + offline_exam_id;
            return $.ajax({
                url: url,
                type: 'get',
    ...
    var viewModel = {
        ...
        init: function () {
            ...
            store.get().then(function (data) {
                ...
                if (rData.visible_config.type == 1) {
            ...
            // })
            // http://elearning-online-gateway.local.web.nd:8080/onetest/admin/offline_exam/60f8611e-1743-49c1-b282-9f25504ffe79/edit

        },
        goEdit: function () {
            window.location = '/' + projectCode + '/admin/offline_exam/' + offline_exam_id + '/edit?source=' + window.source + '&return_url='  + return_url;
        },
        _restore: function () {
            var _self = this;
            if (online_exam_id) {
