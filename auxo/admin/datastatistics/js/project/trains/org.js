(function(window, $) {
    ...
    var store = {
        list: function(filter) {
            var uri = '/v1/datastatistics/train/org_stats';
            return $.ajax({
                url: uri,
                data: filter
            });
        ...
        output: function(options) {
            var uri = '/v1/datastatistics/train/org_stats/export';
            return $.ajax({
                url: uri,
                data: options
            });
    ...
    ViewModel.prototype = {
        ...
        _list: function() {
            ...
            _filter.train_ids.length && (_filter.train_ids = _filter.train_ids.join(','));
