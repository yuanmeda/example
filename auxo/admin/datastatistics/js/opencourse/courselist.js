(function(window, $) {
    ...
    var store = {
        list: function(filter) {
            var uri = '/v1/datastatistics/opencourse/' + opencourseId + '/course_stats';
            return $.ajax({
                url: uri,
                data: filter
            });
        ...
        output: function(options) {
            var uri = '/v1/datastatistics/opencourse/' + opencourseId + '/course_stats/export';
            return $.ajax({
                url: uri,
                data: options
            });
