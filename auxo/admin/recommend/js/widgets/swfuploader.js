...
define(["require", "exports", "./uploader", "../upload/addins/common/event"], function (require, exports, uploader, evt) {
    var SwfUploader = (function (_super) {
        ...
        function SwfUploader(setting) {
            ...
            require(["../../../../addins/swfupload/v2.5.0/swfupload", "../../../../addins/swfupload/v2.5.0/plugins/swfupload.queue"], function () { return _this.onready(); });
        }
        ...
        SwfUploader.prototype.getSetting = function () {
            ...
            s.button_cursor = -2;
            s.flash_url = require.toUrl("../../../../addins/swfupload/v2.5.0/flash/swfupload.swf");
