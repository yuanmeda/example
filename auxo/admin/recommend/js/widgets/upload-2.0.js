define(["require", "exports", "admin/recommend/js/upload/swfuploader"], function (require, exports, swf) {
            ...
            uploader.addEventListener("uploadSuccess", function (e) {
                ...
                if (e.data.Data) {
                    ...
                    if (/\.(BMP|JPG|GIF|PNG|JPEG|ICO)$/.test(e.file.type.toUpperCase())) {
                        t.viewMode.sendedImgUrl($.isArray(e.data.Data) ? e.data.Data[0].AbsoluteUrl : e.data.Data.AbsoluteUrl);
                    }
                    else {
