        ...
        _init: function (urls) {
            ...
            _self.store.catalogs().done(function (data) {
                if (typeof data !== undefined && data !== null && data != "") {
                    ...
                    $(".container-b").css({height: $(window).height() - 220 + "px"});
