(function ($) {
    ...
    var viewModel = {
        init: function () {
            ...
            var ppu = encodeURIComponent(location.origin + '/' + projectCode + '/specialty_2/' + specialtyId + '/exam/' + examId + '/score?source='+source+'&return_url='+encodeURIComponent(return_url));
            var pru = encodeURIComponent(location.origin + '/' + projectCode + '/specialty_2/' + specialtyId + '/courselist?source='+source+'&return_url='+encodeURIComponent(return_url))
