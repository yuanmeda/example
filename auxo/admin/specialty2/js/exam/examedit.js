void function () {
    var store = {
        createSpecialtyExam: function (data) {
            ...
            data.coursecontainer_id = coursecontainer_id;
            data.coumodule_id = coumodule_id === 'null' ? '' : coumodule_id;
            data.specialty_plan_id = specialtyId;
            return $.ajax({
                url: specialtyWebpageApi + '/v1/teaching_plan_courses/exam',
        ...
        init: function () {
            ...
            var message_data = {
                ...
                data: {
                    ...
                    cancelUrl: '/' + projectCode + '/specialty_2/' + specialtyId + '/courselist?source=' + source + '&return_url=' + encodeURIComponent(return_url),
                    saveThenNextUrl: '/' + projectCode + '/specialty_2/' + specialtyId + '/exam/' + examId + '/score?source=' + source + '&return_url=' + encodeURIComponent(return_url)
                }
            };
