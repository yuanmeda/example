...
;(function ($, ko, undefined) {
        ...
        setSortableOption: function () {
            ...
            return $.extend({
                ...
                stop: function (event, ui) {
                    ...
                    This.callbackWrap(leoSortableOp.sortableStop, event, ui, {
                        targetItem: targetItem,
                        dropItem: dropItem,
                        targetIndex: targetIndex,
                        dropIndex: dropIndex,
                        $el: $el,
                        sortableKoItems: This.sortableKoItemsWrap(targetIndex, dropIndex, targetItem, dropItem, data)
                    })
                    targetItem = null
                    dropItem = null
                    data = null
    ...
    ko.components.register('x-leosortable', {
        viewModel: {
