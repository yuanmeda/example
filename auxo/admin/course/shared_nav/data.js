...
(function($) {
    ...
    window.routeString={
        //课程列表
        '1.1.1':'/' + projectCode+ '/course/test',
        //课程分类
        '1.1.2':'/' + projectCode+ '/auxo/course/admin/course/courseslabel',
        //课程基本信息
        '1.2.1':'/' + projectCode+ '/course/${courseId}',
        //编辑课程
        '1.2.99':'/' + projectCode+ '/course/${courseId}/edit',
        //课程章节
        '1.2.2':'/' + projectCode+ '/course/${courseId}/chapter',
        //报名设置
        '1.2.3':'/' + projectCode+ '/course/${courseId}/enroll_setting',
        //考试管理(考试列表)
        '1.2.4':'/' + projectCode+ '/course/${courseId}/exam',
        //编辑考试
        '1.2.98-2':'/' + projectCode+ '/course/${courseId}/exam/${examId}/edit',
        //新建考试
        '1.2.98-1':'/' + projectCode+ '/course/${courseId}/exam/create',
        //考试试卷列表
        '1.2.96':'/' + projectCode+ '/course/${courseId}/exam/${examId}/paper_setting',
        //开考条件
        '1.2.97':'/' + projectCode+ '/course/${courseId}/exam/${examId}/condition',
        //成绩管理
        '1.2.95':'/' + projectCode+ '/course/${courseId}/achievement?exam_id=${examId}',
        //课程统计
        '1.2.5':'/' + projectCode+ '/course/${courseId}/stat',
        //学员管理
        '1.2.6':'/' + projectCode+ '/course/${courseId}/user',
        //新加课程资源下的课程章节
        '1.2.7':'/' + projectCode+ '/course/${courseId}/resource_chapter'
    };
})(jQuery);
