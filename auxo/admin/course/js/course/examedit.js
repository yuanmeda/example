(function (window, $) {
    ...
    var viewModel = {
        ...
        _layDateInit: function () {
            ...
            //         _self.model.exam.begin_time(datas);
            //     }
            // };
            // var endTime = {
            //     elem: '#endTime',
            ...
            //         _self.model.exam.end_time(datas);
            //     }
            //  };
            // laydate(beginTime);
            // laydate(endTime);
            ...
            //         $(this.elem).valid();
            //         // 设置时间
            //         acEndTime.min = datas; //开始日选好后，重置结束日的最小日期
            //         acEndTime.start = datas; //将结束日的初始值设定为开始日
            //         _self.model.analysisTime.begin_time(datas);
            //     }
            // };
            // var acEndTime = {
            //     elem: '#acEndTime',
            ...
            //         $(this.elem).valid();
            //         // 设置时间
            //         acBeginTime.max = datas; //结束日选好后，重置开始日的最大日期
            //         _self.model.analysisTime.end_time(datas);
            //     }
            // };
            // laydate(acBeginTime);
            // laydate(acEndTime);
