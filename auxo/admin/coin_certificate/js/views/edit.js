(function ($) {
    ...
    var store = {
        ...
        getTrainList: function () {
            var url = '/v1/coin_certificates/trains';
            return $.ajax({
                url: url,
                type: 'GET',
                cache: false
        ...
        getCourseList: function (data) {
            var url = '/v1/coin_certificates/trains/' + data.train_id + '/courses';
            return $.ajax({
                url: url,
                type: 'GET',
                cache: false
        ...
        getChapterList: function (data) {
            var url = '/v1/coin_certificates/courses/' + data.course_id + '/chapters';
            return $.ajax({
                url: url,
                type: 'GET',
                cache: false
        ...
        getCoinCertificate: function () {
            return $.ajax({
                url: '/v1/coin_certificates/' + coinId,
                type: 'GET',
                dataType: "json",
                cache: false
            });
