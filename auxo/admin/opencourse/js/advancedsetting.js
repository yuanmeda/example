;(function ($) {
    ...
    var store = {
        ...
        getRequiredObj:function(){
            var url = '/' + projectCode + '/open_courses/' + courseId + '/require_objects';
            return $.ajax({
                url: url,
                type: 'GET',
                cache: false
    ...
    var viewModel = {
        ...
        backPage: function () {
            window.parent.location.href = '/' + projectCode + "/open_course/" + courseId + "/advancedsetting?source=" + source + "&return_url=" + encodeURIComponent(return_url);
        },
        toEdit: function () {
