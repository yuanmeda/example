...
(function ($, window) {
  ...
  var store = {
    ...
    post: {
      ...
      pass: function (courseId) {
        var url = '/' + projectCode + '/open_courses/' + courseId + '/actions/pass';
      ...
      reject: function (courseId, data) {
        var url = '/' + projectCode + '/open_courses/' + courseId + '/actions/refuse';
      ...
      submit: function (courseId, data) {
        var url = '/' + projectCode + '/open_courses/' + courseId + '/actions/submit';
  ...
  var viewModel = {
    ...
    createCourse: function () {
      window.parent.location.href = "/" + projectCode + '/open_course/create?course_id=0'
    },
