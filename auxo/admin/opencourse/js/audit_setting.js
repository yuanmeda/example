  ...
  var store = {
    query: {
      configs: function (data) {
        var url = '/' + projectCode + '/open_courses/configs';
        return $.ajax({
          url: url,
          cache: false,
          data: data,
    ...
    put: {
      configs: function (data) {
        var url = '/' + projectCode + '/open_courses/configs?business_id=' + data.business_id + '&business_type=' + data.business_type + '&item_key=' + data.item_key;
        return $.ajax({
          url: url,
          data: JSON.stringify({
