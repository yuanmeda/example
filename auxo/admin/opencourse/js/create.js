        ...
        updateCourseInfo: function (data) {
            ...
            store.updateCourse(postData).done(function () {
                $.fn.dialog2.helpers.confirm("编辑成功!", {
                    "confirm": function () {
                        window.parent.location.href = '/' + projectCode + "/open_course/" + courseId + "/chapter?source=" + source + "&return_url=" + encodeURIComponent(return_url);
                    },
                    "decline": function () {
        ...
        createUnitCourse: function (data) {
            ...
            store.createCourse(postData).done(function (returnData) {
                ...
                $.fn.dialog2.helpers.confirm("创建成功!", {
                    ...
                    "decline": function () {
                        window.parent.location.href = "/" + projectCode + "/open_course/manage?source=" + source + "&return_url=" + encodeURIComponent(return_url);
                    },
                    "close": function () {
                        window.parent.location.href = "/" + projectCode + "/open_course/manage?source=" + source + "&return_url=" + encodeURIComponent(return_url);
                    },
