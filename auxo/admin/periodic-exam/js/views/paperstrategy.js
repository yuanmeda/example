(function ($) {
    var store = {
        ...
        get: function () {
            var url = apiServiceDomain + '/v1/periodic_exams/' + periodic_exam_id;
            return $.ajax({
                url: url,
                type: 'GET',
            ...
            store.update(model)
                .done(function () {
                    if (return_url) {
                        ...
                        window.location.href = '/' + projectCode + '/admin/periodic_exam/adminTest'
                    }
                })
        },
        lastStepEvent: function () {
            location.href = '/' + projectCode + '/admin/periodic_exam/bank?project_code=' + projectCode + '&periodic_exam_id=' + periodic_exam_id + '&return_url=' + encodeURIComponent(return_url);
        }
    };
    $(function () {
        viewModel.init();
