    ...
    var Upload = (function () {
        ...
        Upload.prototype._load = function () {
            ...
            uploader.addEventListener("queued", function (e) {
                ...
                t.setPostParams({name: e.file.name});
            ...
            uploader.addEventListener("uploadSuccess", function (e) {
                ...
                if (e.data) {
                    ...
                    if (/\.(BMP|JPG|GIF|PNG|JPEG|ICO)$/.test(e.file.type.toUpperCase())) {
                        //http://betacs.101.com/v0.1/download/?dentryId=0137ace8-f1ad-49bb-906a-06cd4456b54a
                        var imgUrl = csUrl + '/v0.1/download/?dentryId=' + e.data.dentry_id;
                        t.viewMode.sendedImgUrl(imgUrl);
                    }
                    else {
        ...
        return this.addClass("upload").each(function (index, item) {
            ...
            if (!data) {
                ...
                if (option.defaultUrl) {
                    data.resetDefaultImgUrl(option.defaultUrl);
                }
            }
            if (optionIsString) {
                if ($.isFunction(para)) {
