...
(function ($) {
    ...
    var store = {
        getAccessToken: function (data) {
            var url = '/' + projectCode + '/v1/auctoken';
            return commonJS._ajaxHandler(url, data, 'GET');
        },
    ...
    var viewModel = {
        ...
        init: function () {
            ...
            _self.model.filter.question_bank_id = window.questionbankId;
        ...
        getAccessToken: function () {
            var data = {
                id: window.questionbankId,
                type: 'question_bank'
            };
            store.getAccessToken(data).done(function (data) {
        ...
        editPaper: function(data) {
            if (data.word_id) {
                window.location = protocalName + "/resource/word?wordId=" + data.word_id + "&accesstoken=" + accessToken + "&appId=" + appId;
            } else {
