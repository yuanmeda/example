...
!function ($, moment) {
    ...
    DateRangePicker.prototype = {
        ...
        hide: function (e) {
            ...
            // remove the same condition, because it is auto select a range when initial, but do not notify the callback
            // so for this, we force to notify.
            //if (!this.startDate.isSame(this.oldStartDate) || !this.endDate.isSame(this.oldEndDate))
                this.notify();
        ...
        clickDate: function (e) {
            ...
            // fix in IE
            // calendars will be closed after clickDate but never apply it.
            e.stopPropagation();
        },
