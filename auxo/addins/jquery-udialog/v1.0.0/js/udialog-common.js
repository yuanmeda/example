(function ($) {
    ...
    $.fn.udialog = function (options) {
        ...
        window.setTimeout(function () {
            $('.ui-icon.ui-icon-closethick').parent().trigger('focus');
            $('.udialog-icon.udialog-icon-info').removeClass('udialog-icon-info').addClass('udialog-icon-info');
        }, 0);
    ...
    var __helpers = {
        alert: function (content, options, func) {
            ...
            $(".ui-icon-closethick", u.prev()).unbind("click").click(onClose);
            $(".ui-btn-primary", u.next()).unbind("click").click(onClose);
