    ...
    var __helpers = {
        ...
        *   });
        ...
        alert: function (message, options) {
            ...
            options.modalCloseCallback = closeCallback;
        ...
        *   });
        ...
        confirm: function (message, options) {
            ...
            var confirm1Callback = options.confirm1;
            delete options.confirm1;
            ...
            options.modalCloseCallback = options.close;

            var buttons = {};
            localizedButton(labels.buttonLabelYes, {
                click: __closeAndCall(confirmCallback, dialog),
                primary: true
            }, buttons);
        ...
        *   });
        ...
        prompt: function (message, options) {
            ...
            var buttons = {};
            localizedButton(labels.buttonLabelOk, {click: __closeAndCall(okCallback, dialog), primary: true}, buttons);
