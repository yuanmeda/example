...
(function ($) {
     ...
     * Dialog html markup
     */
    var __DIALOG_HTML = "<div class='modal' data-backdrop='static' style='z-index:1070;'>" +
        "<div class='modal-header bsloading'>" +
    ...
    var Dialog2 = function (element, options) {
        ...
        handle.bind("dialog2.ajax-start", function () {
            ...
            handle.parent().addClass("bsloading");
        });
        ...
        handle.bind("dialog2.ajax-complete", function () {
            handle.parent().removeClass("bsloading");
        });
    ...
    Dialog2.prototype = {
        ...
        __init: function (element, options) {
            ...
            if (!selection.is(".modal-body")) {
                var overlay = $('<div class="modal-backdrop" style="z-index:1060;"></div>').hide();
                ...
                $(".modal-header a.close", parentHtml)
                    ...
                    .click(function (event) {
                        ...
                        $(this).parents(".modal").find(".modal-body").dialog2("close");
                        if (closeOptions.modalCloseCallback && $.isFunction(closeOptions.modalCloseCallback))closeOptions.modalCloseCallback();
                    });
        ...
        __updateMarkup: function () {
            ...
            var actions = $(".form-actions", e).css({
                position: "absolute",
                left: "-9999px",
                width: "1px",
                height: "1px"
            ...
            if (!dialog.is(".opened")) {
                ...
                try {
                    if (window.frameElement && window.frameElement.tagName == "IFRAME") {
                        ...
                        top = top + ($(window.top).height() - dialog.parent().height()) / 2;
                        if (top < 250) {
                            top = 250;
                        }
