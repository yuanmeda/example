var i18n = {
    common: {
        ...
        //前台页面
        frontPage: {
            newMessageTips: 'HI！{{name}}，您订阅的标签组已有新内容上线啦，快来学习吧！',
            ...
            //注册
            projectSignUpIn: '{{projectTitle}} - 注册',
            //修改密码
            projectPasswordModify: '{{projectTitle}} - 修改密码',
            /*
             标签相关
             */
            //对
            ...
            mySubscribe: '我的订阅',
            loginBeforeSubscribe: '使用订阅服务请先登录哦！',
            subscribeSuccess: '订阅成功',
            moreSubscribeTips: '注：您已订阅超过20组内容，可进入“我的订阅”列表，对已订阅的内容进行查看管理。',
            subscribedTips:  '已成功订阅{{channelName}}频道中{{tagsName}}的内容,有内容更新时会提示您。',
            unSubscribedTips: '正在取消订阅{{channelName}}频道中{{tagsName}}的内容,取消后将不再收到更新提示',
            /*
             课程相关
             */
            //列表选项
    ...
    register: {
        "frontEnd": {
            ...
            "nickname": "昵称(3-20位，中英文，数字或下划线)",
            "password": "密码(6-20位，数字、字母和符号至少两种)",
            "confirm_password": "确认密码",
            "hava_account": "已有账号？"
        },
        "validate": {
            "none_mobile": "手机号码不能为空",
            "invalid_mobile": "手机格式不正确",
            "invalid_password": "数字、字母和符号至少包含两种，最少6位，最大20位",
            "blank_character": "密码不能输入空格",
            "invalid_verification_code": "请输入验证码",
            "invalid_verification_code_fail": "验证码错误，请重新输入",
            "invalid_nickname_char": "昵称为中英文，数字或下划线",
            "invalid_nickname": "请输入昵称",
            "invalid_nickname_min": "昵称最小长度为3个字符",
            "invalid_nickname_max": "昵称最大长度为20个字符",
            "invalid_confirm_password": "两次密码输入不一致"
        }
    },
    "password": {
        "modify": {
            "title": "修改密码",
            "oldPassword": "请输入旧密码",
            "newPassword": "新密码（6-20位，数字、字母和符号至少两种）",
    ...
    login: {
        frontPage: {
            ...
            staticText8: '用户中心获取验证码异常，<br>请稍后刷新浏览器重试。',
            //用户中心服务器异常，请稍后刷新浏览器重试。
            staticText9: '用户中心服务器异常，<br>请稍后刷新浏览器重试。',
            //请输入用户名
            staticText10: '请输入用户名',
            staticText11: '请输入所在组织帐号'
        }
    },
    /*
     我的学习页面
