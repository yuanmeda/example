(function ($) {
    ...
    require(["learning.exam.factory"], function (factory) {
        var languageVarl;
        ...
        var config = {
            "host": {
                ...
                "returnUrl": "http://" + window.location.host + selfUrl + "/" + projectCode + "/exam/end"        // 必填，结果页面地址
            },
            "envConfig": {
                "examId": examId,                                                                      // 必填，当前考试标志。
                "sessionId": "ccdc2e6c-d243-4807-a44a-4f3d48ea7977",
        ...
        var bussiness = factory.Learning.ExamBussinessFactory.CreateSingleModeExam(config);
        // bussiness.init();
