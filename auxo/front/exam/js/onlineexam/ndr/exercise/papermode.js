            ...
            $.when.apply({}, defs).done(function () {
                ...
                var config = {
                    ...
                    Exam: {
                        ...
                        "EndTime": examInfo.endTime ? new Date(examInfo.endTime).getTime() : _enum.Studying.ConstValue.MaxExamEndTime, //new Date('2016/03/26 23:00:00').getTime(), //// 单位毫秒
                        "Mode": 1,
                        "PassScore": examInfo.passingScore,
                        "Summary": examInfo.description,
                        "Chance": examInfo.examChance, // 考试机会
                        "ExamResultPageUrl": returnUrl ? returnUrl : "http://" + window.location.host + '/' + projectCode + "/exam/exercise/analysis", // 考试结束后要跳转的页面
