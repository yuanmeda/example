(function ($) {
    ...
    require(["studying.exam.singleanswer", "studying.enum"], function (answer, _enum) {
        ...
        var returnUrl = decodeURIComponent(getQueryStringByName('__return_url'));
        ...
        function init(mine, exam, answersData, analysisData) {
            ...
            var config = {
                ...
                "Exam": {
                    ...
                    "EndTime": exam[0].endTime ? new Date(exam[0].endTime).getTime() : _enum.Studying.ConstValue.MaxExamEndTime, //new Date('2016/03/26 23:00:00').getTime(), //// 单位毫秒
                    "Mode": 1,
            ...
            $.studying.loading.show();
            var main = new answer.Studying.ExamSingleAnswer();
            main.init(config);
