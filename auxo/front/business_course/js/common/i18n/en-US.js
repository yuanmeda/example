...
i18n.courseComponent = {
    front: {
        ...
        courseDetail: {
            goPK:'PK Start!',
            noPKs: 'No PKs',
            noPKChapters:'Please select one chapter to start PK!',
            passMethod: "通过方式",
            periodTitle: "修满{{period}}学时",
            area: "地点：",
            offlineStudy: "Offline Study",
            noData: "No Data!",
            more: "More",
            less: "Less",
            courseCatalog: "Chapters",
            knowledgeCatalog: "Knowledges",
            noResource: "No Resource",
            page: "Page",
            learned: "Learned:",
            learnhour: "Hour",
            exercise: "Exercise",
            resourceRecommend: "Resource",
            lecturer: "Lecturer",
            enrollTime: "Enroll Time:",
            courseEffectiveTime: "Effective Time of Study:",
            learn: "Learn",
            questionBank: "Error Questions",
            ranking: "Ranking",
            pk: 'PK',
