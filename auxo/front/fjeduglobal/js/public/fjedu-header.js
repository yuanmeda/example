    ...
    var viewModel = {
        ...
        go: function () {
            ...
            switch (this.type) {
                ...
                case '课程':
                    if (this.account.role_name == 'teacher')
                        url = _FJEDU_CONFIG.channelUrl + '/tedu/search?keyword=' + keyword;
                    else if (this.account.role_name == 'guardian')
                        url = _FJEDU_CONFIG.channelUrl + '/pedu/search?keyword=' + keyword;
                    else
                        url = _FJEDU_CONFIG.channelUrl + '/edu/search?keyword=' + keyword;
                    break;
                default:
