(function ($, window) {
    ...
    var viewModel = {
        ...
        init: function () {
            ...
            this.model.currentNav.subscribe(function (nav) {
                switch (nav) {
                    case 8:// 作业
                        this.childIndex(1);
                        break;
        ...
        childMenuClick: function (nav, a, evt) {
            ...
            switch (nav) {
                ...
                case 7:
                    //笔记-我的笔记
                    url = this.url_by_note(this.model.currentUrl(), 3);
                    break;
                case 8:
                    //笔记-全部笔记
                    url = this.url_by_note(this.model.currentUrl(), 2);
                    break;
                case 9:
                    //问答-我的提问
                    url = this.url_by_qa(this.model.currentUrl(), 0);
                    break;
                case 10:
                    //问答-我的回答
                    url = this.url_by_qa(this.model.currentUrl(), 1);
                    break;
                case 11:
                    //问答-我的关注
                    url = this.url_by_qa(this.model.currentUrl(), 6);
                    break;
                case 12:
                    //问答-全部问题
                    url = this.url_by_qa(this.model.currentUrl(), 2);
                    break;
            }
        ...
        url_by_note: function (host, mode) {
            var projectCode = 'k12';
            switch (roleName) {
                case 'guardian':
                    projectCode = 'pfjedu';
