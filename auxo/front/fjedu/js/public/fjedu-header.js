    ...
    var viewModel = {
        ...
        nextStep: function (res) {
            ...
            switch (this.account.role_name) {
                case 'student':
                    ...
                    $('#js_user_center').attr('href', _FJEDU_CONFIG.elearningUrl + '/k12/mystudy/user_center');
                    break;
                case 'teacher':
                    ...
                    $('#js_user_center').attr('href', _FJEDU_CONFIG.elearningUrl + '/fjedu/mystudy/user_center');
                    break;
                case 'guardian':
                    ...
                    $('#js_user_center').attr('href', _FJEDU_CONFIG.elearningUrl + '/pfjedu/mystudy/user_center');
                    break;
                default:
        ...
        go: function () {
            ...
            switch (this.type) {
                ...
                case '课程':
                    if (this.account.role_name == 'teacher')
                        url = _FJEDU_CONFIG.channelUrl + '/fjedu/search?keyword=' + keyword;
                    else if (this.account.role_name == 'guardian')
                        url = _FJEDU_CONFIG.channelUrl + '/pfjedu/search?keyword=' + keyword;
                    else
                        url = _FJEDU_CONFIG.channelUrl + '/k12/search?keyword=' + keyword;
                    break;
                default:
